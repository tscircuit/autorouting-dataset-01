...
Script to automatically generate README.md files for specified directories. It parses the files in each directory and updates the corresponding README.md with information about the exported components or functions. Usage: bun scripts/genratedocs.ts [--dirs=lib:-1,scripts:1,types:-1,imports:-1]
