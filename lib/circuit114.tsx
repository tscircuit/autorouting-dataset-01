...
export default () => (
  <board width="36.00mm" height="21.00mm">
    ...
    <resistor name="resistor-2" footprint="0603" pcbX={9.00} pcbY={-6.00} connections={{
        pin2: "net.N5",
        pin1: "net.N7",
      }} resistance="1k" />
    ...
    <inductor name="inductor-1" footprint="0603" pcbX={-13.50} pcbY={4.50} connections={{
        pin1: "net.N3",
        pin2: "net.N9",
      }} inductance="10uH" />
    ...
    <resistor name="resistor-3" footprint="0603" pcbX={-1.00} pcbY={3.00} connections={{
        pin1: "net.N7",
        pin2: "net.N8",
      }} resistance="1k" />
    ...
    <chip name="chip-2" footprint="pinrow8" pcbX={8.50} pcbY={5.50} connections={{
        pin1: "net.N1",
        pin2: "net.N1",
        pin3: "net.N4",
        pin4: "net.N4",
