...
export default () => (
  <board width="22.00mm" height="22.00mm">
    ...
    <pinheader name="pinhead-1" footprint="pinheader6" pcbX={0.00} pcbY={-6.00} connections={{
        pin5: "net.N1",
        pin1: "net.N2",
        pin6: "net.N2",
        pin4: "net.N3",
    ...
    <transistor name="transistor-2" footprint="SOT-223" pcbX={1.00} pcbY={4.50} connections={{
        pin1: "net.N2",
        pin3: "net.N4",
        pin2: "net.N4",
      }} type="npn" />
    <capacitor name="capacitor-1" footprint="0805" pcbX={-4.00} pcbY={-2.00} connections={{
        pin2: "net.N1",
        pin1: "net.N3",
      }} capacitance="0.1uF" />
  </board>
