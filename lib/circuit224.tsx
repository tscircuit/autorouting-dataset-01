...
export default () => (
  <board width="46.00mm" height="26.00mm">
    ...
    <transistor name="transistor-1" footprint="SOT-223" pcbX={3.00} pcbY={7.00} connections={{
        pin2: "net.N4",
        pin1: "net.N10",
        pin3: "net.N12",
      }} type="npn" />
    <pinheader name="pinhead-1" footprint="pinheader2" pcbX={12.00} pcbY={-7.50} connections={{
        pin2: "net.N3",
        pin1: "net.N11",
    ...
    <chip name="chip-2" footprint="pinrow8" pcbX={-10.00} pcbY={2.00} connections={{
        pin6: "net.N1",
        pin7: "net.N5",
        pin1: "net.N5",
        pin4: "net.N6",
    ...
    <resistor name="resistor-3" footprint="0805" pcbX={12.00} pcbY={-1.00} connections={{
        pin2: "net.N11",
        pin1: "net.N12",
      }} resistance="1k" />
    ...
    <transistor name="transistor-3" footprint="SOT-223" pcbX={14.00} pcbY={6.00} connections={{
        pin1: "net.N5",
        pin3: "net.N7",
        pin2: "net.N10",
      }} type="npn" />
    <diode name="diode-5" footprint="SOD-323" pcbX={-14.00} pcbY={-9.00} connections={{
        pin1: "net.N6",
        pin2: "net.N9",
      }} />
  </board>
