...
export default () => (
  <board width="16.00mm" height="26.00mm">
    ...
    <transistor name="transistor-2" footprint="SOT-223" pcbX={-1.50} pcbY={5.00} connections={{
        pin3: "net.N2",
        pin2: "net.N2",
        pin1: "net.N6",
      }} type="npn" />
    ...
    <inductor name="inductor-1" footprint="0402" pcbX={-4.00} pcbY={-9.00} connections={{
        pin1: "net.N5",
        pin2: "net.N6",
      }} inductance="10uH" />
    <diode name="diode-3" footprint="SOD-323" pcbX={-0.50} pcbY={-7.00} connections={{
        pin1: "net.N4",
        pin2: "net.N4",
      }} />
  </board>
