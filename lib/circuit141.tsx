...
export default () => (
  <board width="21.00mm" height="21.00mm">
    ...
    <diode name="diode-5" footprint="SOD-323" pcbX={3.00} pcbY={5.00} connections={{
        pin2: "net.N4",
        pin1: "net.N5",
      }} />
    <capacitor name="capacitor-3" footprint="0805" pcbX={3.50} pcbY={-3.50} connections={{
        pin1: "net.N2",
        pin2: "net.N5",
      }} capacitance="0.1uF" />
    <diode name="diode-6" footprint="SOD-123" pcbX={4.50} pcbY={0.00} connections={{
        pin2: "net.N3",
        pin1: "net.N4",
      }} />
  </board>
